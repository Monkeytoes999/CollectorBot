				...
				bot.getMessage({ channelID: '509160162959949825', messageID: '514281997506707471' }, function (bad, tacobell){
					...
					if (message.length > 30 && validSyn){
						...
						if (tacobell.content.includes(message.substring(userrcID, userrcID + 18)) && message.substring(6,7) == 'L'){
							...
							bot.sendMessage({
								to: channelID,
								message:  message.substring(userrcID - 3, subofGive - 1) + ', you\'ve been gifted ' + message.substring(subofGive) + ' <:lead:509862462712053762>lead!'
							});
							bot.getMessage({
								channelID: '509149632618823681',
							...
							bot.sendMessage({
								to: channelID,
								message: message.substring(userrcID - 3, subofGive - 1) + ', you\'ve been gifted ' + message.substring(subofGive) + ' karma!'
							});
							bot.getMessage({
								channelID: '509149632618823681',
								messageID: recieverMessID
								...
								bot.editMessage({
									channelID: '509149632618823681',
									messageID: recieverMessID,
									message: ress.content.substring(0, ress.content.indexOf(',')) + ', ' + (parseInt(karmaMess.substring(0, karmaMess.indexOf(','))) + parseInt(message.substring(subofGive))) + karmaMess.substring(karmaMess.indexOf(','))
								});
							});
						} else {
							bot.sendMessage({
